...
import fr.plum.plumlib.io.database.PlumRequester;
import fr.plum.plumlib.io.database.components.DBTable;
...
/**
 * Wrapper to create a fragment of the database linked to the DBConnection.
 * Check & Create given tables of the DB.
 * @author Meltwin
 * @since 1.1.0
 */
public class DBFragment extends PlumRequester {
    ...
    private void check() throws DBException {
        ...
        sendMessage(CONSOLE(), String.format(DBMessages.FRAG_CHECK_RESULT.getMessage(),calcMissingDBNumber(),tables.size()));
    }
    ...
    private void buildTable() throws DBException {
        ...
        sendMessage(CONSOLE(), DBMessages.FRAG_BUILD_END.getMessage());
    }
    // !SECTION
    ...
    private void makeLines() throws DBException {
        ...
        sendMessage(CONSOLE(), DBMessages.FRAG_LINE_END.getMessage());
    }
    // !SECTION
    ...
    private void changeStep(DBMessages msg, BuildSteps step) {
        sendMessage(CONSOLE(), msg.getMessage());
        this.step = step;
        clear();
    }
    // !SECTION
